  ...
  //  @Bind(R.id.iv_next)
   ...
   // @Bind(R.id.iv_prev)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        llContent = (LinearLayout)getView().findViewById(R.id.ll_content);
        ivPlayingBg = (ImageView)getView().findViewById(R.id.iv_play_page_bg);
        ivBack = (ImageView)getView().findViewById(R.id.iv_back);
        tvTitle = (TextView)getView().findViewById(R.id.tv_title);
        tvArtist = (TextView)getView().findViewById(R.id.tv_artist);
        vpPlay = (ViewPager)getView().findViewById(R.id.vp_play_page);
        ilIndicator = (IndicatorLayout)getView().findViewById(R.id.il_indicator);
        sbProgress = (SeekBar)getView().findViewById(R.id.sb_progress);
        tvCurrentTime = (TextView)getView().findViewById(R.id.tv_current_time);
        tvTotalTime = (TextView)getView().findViewById(R.id.tv_total_time);
        ivMode = (ImageView)getView().findViewById(R.id.iv_mode);
        ivPlay = (ImageView)getView().findViewById(R.id.iv_play);
        ivNext = (ImageView)getView().findViewById(R.id.iv_next);
        ivPrev = (ImageView)getView().findViewById(R.id.iv_prev);
