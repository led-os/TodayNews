...
public class VideoAdapter extends BaseQuickAdapter<Music> {
    public VideoAdapter(List<Music> data) {
        super(R.layout.item_video_list, data);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, final Music news) {
...
//        }
    ...
    private void setPlayer(JCVideoPlayerStandard videoPlayer, Music news) {
